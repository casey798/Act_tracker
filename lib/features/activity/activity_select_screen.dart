...
class ActivitySelectScreen extends StatelessWidget {
    ...
    return AppBackground(
      child: SafeArea(
        child: Column(
          ...
          children: [
            // Custom Header with Category Badge
            Padding(
            ...
            // Exploding Grid of GlassBlobs
            Expanded(
              child: activities.isEmpty
              ? const Center(child: Text('No activities found', style: TextStyle(color: Colors.white54)))
              : Center(
                  child: ConstrainedBox(
                    constraints: BoxConstraints(maxWidth: maxGridWidth),
                    child: GridView.builder(
                      padding: EdgeInsets.all(padding),
                      clipBehavior: Clip.none, // Allow blobs to overlap bounds slightly
                            ...
                            return Transform.translate(
                              ...
                              child: RepaintBoundary(
                                child: GlassBlob(
                                  ...
                                  borderRadius: organicBorder,
                                  // Idle rotation
                                  rotation: (index % 2 == 0 ? 0.05 : -0.05) * ((index % 3) + 1) * 0.3,
                                  delay: Duration.zero,
  ...
  List<String> _getActivitiesForCategory(String category) {
    // Labels passed from HomeScreen are 'Focus', 'Social', 'Rest', 'Idle'
    switch (category) {
      case 'Focus':
